...
#python src/main.py --model EDSR --data_test video --dir_demo test/lr30.mp4 --save edsr_baseline_x4 --pre_train ./experiment/model/EDSR_x4.pt --n_resblocks 32 --n_feats 256 --res_scale 0.1 --test_only
#export NPY_MKL_FORCE_INTEL=1
export MKL_SERVICE_FORCE_INTEL=1
#python src/main.py --data_test Demo --dir_demo splite_image --scale 4 --pre_train ./experiment/model/EDSR_x4.pt --n_resblocks 32 --n_feats 256 --res_scale 0.1 --test_only --save_results --n_GPUs 4
#python src/main.py --data_test Demo --dir_demo splite_image --scale 3 --pre_train ./experiment/model/EDSR_x3.pt --n_resblocks 32 --n_feats 256 --res_scale 0.1 --test_only --save_results --n_GPUs 4

#python src/main.py --data_test Demo --dir_demo splite_image --scale 8 --pre_train ./experiment/edsr_x8/model/model_best.pt --n_resblocks 32 --n_feats 256 --res_scale 0.1 --test_only --save_results --n_GPUs 4
#python src/main.py --data_test Demo --dir_demo splite_image --scale 2 --pre_train ./experiment/model/EDSR_x2.pt --n_resblocks 32 --n_feats 256 --res_scale 0.1 --test_only --save_results --n_GPUs 1
#python src/main.py --data_test Demo --dir_demo splite_image --scale 2 --pre_train ./experiment/model/edsr_baseline_x2.pt --test_only --save_results --self_ensemble --chop


# RCAN_BIX2
#python src/main.py --data_test Demo --dir_demo splite_image --scale 2 --model RCAN --n_resgroups 10 --n_resblocks 20 --n_feats 64 --pre_train ./experiment/rcan_model/RCAN_BIX2.pt --test_only --save_results --chop
# RCAN_BIX3
#python src/main.py --data_test Demo --dir_demo splite_image --scale 3 --model RCAN --n_resgroups 10 --n_resblocks 20 --n_feats 64 --pre_train ./experiment/rcan_model/RCAN_BIX3.pt --test_only --save_results
## RCAN_BIX4
python src/main.py --data_test Demo --dir_demo splite_image --scale 4 --model RCAN --n_resgroups 10 --n_resblocks 20 --n_feats 64 --pre_train ./experiment/rcan_model/RCAN_BIX4.pt --test_only --save_results --chop
#